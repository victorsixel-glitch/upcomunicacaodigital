                ...
                >
                  ...
                  <div className={`flex ${isRight ? "justify-end" : "justify-start"}`}>
                    <div className="w-full md:w-[calc(50%-2rem)]">
                      <div className={`glass-card p-8 rounded-2xl relative overflow-hidden border border-[rgba(255,255,255,0.06)] hover:border-[rgba(255,215,0,0.3)] hover:shadow-[0_0_25px_rgba(255,215,0,0.06)] transition-all duration-500 group ${!isRight ? "md:text-right" : ""}`}>
